...
{   
        ...
        public ChampionList getChampionListFromJson(String json)
            {
                return JsonConvert.DeserializeObject<ChampionList>(json);
            }
        ...
        internal static object GetSummoner (CommonController cc, string v)
		{
